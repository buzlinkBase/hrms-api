...
{
    public class TableSSSWeeklyCalculator : IDeductionCalculator
    {
        public DeductionPipeData Calculate(DeductionPayloadContext context, DeductionPipeData line)
        {
            ...
            {
                var truedUpPayload = new SSSTablePayload(balances.EEBalance, balances.ERBalance, balances.ECBalance);
                return SSSHelper.ApplyTable(context, line, truedUpPayload, context.Payload.FromDate);
            }
