...
namespace Hrms.Infrastructure.Migrations
{
    ...
    [Migration("20260224121603_initial")]
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7317af7d-5919-4807-8d20-0888063ab3eb"),
                            Address = "",
                            Code = "0001",
                            Contact = "",
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "",
                            ApplyStatutoryOnActualMonth = true,
                            Code = "0001",
                            Contact = "",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.CutoffDay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsEndOfMonth = false,
                            Label = "First Cutoff",
                            PayrollGroupId = new Guid("398bbb60-4a8f-4095-a478-59b4f4e6a22f"),
                            Status = "Active",
                            TenantId = new Guid("c1b8aaaf-6bff-4f68-97c7-626f16ea9197")
                        },
                        new
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.EmployeeEntities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("398bbb60-4a8f-4095-a478-59b4f4e6a22f"),
                            Address1 = "",
                            Address2 = "",
                            Age = 0,
                            BankName = "",
                            ...
                            Gender = "",
                            HDMFNo = "",
                            HireDate = new DateOnly(2025, 12, 24),
                            HiringEntity = "",
                            JobLevel = "Managerial",
                            LastName = "cee",
                            MiddleName = "",
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.EmployeeEntities.EmployeeSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1d2ea765-ef66-4b59-8465-f5e21dfc4e06"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EmployeeId = new Guid("398bbb60-4a8f-4095-a478-59b4f4e6a22f"),
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.EmployeeEntities.HDMFRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("50c4f498-7bf9-4516-98b4-c02c260aa028"),
                            AddOns = 0m,
                            ComputationType = "Table",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EE = 0m,
                            ER = 0m,
                            EmployeeId = new Guid("398bbb60-4a8f-4095-a478-59b4f4e6a22f"),
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.EmployeeEntities.PHICRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("19e74c46-bd41-4685-b5d5-957ede63317a"),
                            AddOns = 0m,
                            ComputationType = "Table",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EE = 0m,
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.EmployeeEntities.SSSRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c3925e24-46df-48d6-bce7-24853e1ae9d5"),
                            AddOns = 0m,
                            ComputationType = "Table",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EC = 0m,
