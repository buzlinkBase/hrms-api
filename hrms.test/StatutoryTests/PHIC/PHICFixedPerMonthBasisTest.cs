...
public class PHICFixedPerMonthBasisTest
{
    [Fact]
    ...
    public void ShouldComputePHICContribution_ForFixedBasisMonthlyVariableSalaryDailyPayroll()
    {
        ...
        Assert.NotNull(result.PHIC);
        Assert.Equal(3.2258064516129032258064516129M, result.PHIC.EE);
        Assert.Equal(6.4516129032258064516129032258M, result.PHIC.ER);
