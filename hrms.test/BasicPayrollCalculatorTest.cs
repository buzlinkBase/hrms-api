...
public class BasicPayrollCalculatorTest
{
    ...
    public void ApplyAbsent_WhenWorkTypeIsSet(WorkType workType, bool hasLeave, int expected)
    {
        ...
        if (hasLeave)
        {
            context = LeaveTestHelpers.CreatePayrollContextWithLeave(true, DayFraction.FullDay, 1000);
        }
    ...
    {
        var calculator = new BasicPayrollCalculator();
        var context = LeaveTestHelpers.CreatePayrollContextWithLeave(true, DayFraction.FullDay, 1000);
    ...
    {
        var calculator = new BasicPayrollCalculator();
        var context = LeaveTestHelpers.CreatePayrollContextWithLeave(true, DayFraction.FullDay, 800);
