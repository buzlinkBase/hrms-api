...
public class Payroll : BaseEntity, IPostedFilter, IDateFilter
{
    ...
    public decimal OvertimeHR { get; set; }
    public decimal OvertimePay { get; set; }
    public decimal NightDifferentialHR { get; set; }
    ...
    public decimal GrossIncome { get; set; }//BasicSalary+OT+ND+HolidayPay+Bonuses+Allowances+Commissions
    ...
    public bool IsPosted { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
