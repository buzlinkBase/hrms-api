    ...
    public List<LeaveApplication> GetApplications(DateOnly date)
    {
        ...
        foreach (var app in apps)
        {
            ...
            leaveApps.Add(new LeaveApplication
            {
                ...
                GovernmentAmount= app.GovernmentAmount,
                CompanyAmount= app.CompanyAmount,
                EmployeeId=app.EmployeeId,
                ReleasePayrollDate=app.ReleasePayrollDate,
                Status=app.Status,
                SupportingDocumentUrl=app.SupportingDocumentUrl,
